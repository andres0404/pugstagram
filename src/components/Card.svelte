<script>
    import Comments from "./Coments.svelte";
  ...
  <div class="Card-container">
      ...
      <div class="Card-icons">
          <div class="Card-icon-first">
              <i class="fa-solid fa-heart active-like"
              class:active-like={like}
              on:click={handleLike}
              ></i>
              <i class="fas fa-paper-plane" alt="Compartir" on:click={handleClick}></i>
          </div>
          <div class="Card-icons-second">
              <i class="fa-solid fa-bookmark active-bookmark"
